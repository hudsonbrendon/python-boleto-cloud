...
class Ticket(object):
    ...
    def create(
        ...
        beneficiario_endereco_uf,
        beneficiario_endereco_localidade,
        beneficiario_endereco_bairro,
        beneficiario_endereco_logradouro,
